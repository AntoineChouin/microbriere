...
var app4 = new Vue({
  ...
  , data: {
    todos: [
      {
        title: {
          principale: 'Build something awesome'
          , secondaire: "Voici un farfadelle, la femelle sauvage"
        }
        , info: {
        ...
        , descriptif: {
          ...
          , alcool: "4.5%"
          , verre: "pinte"
          , veillessement: "4 mois"
        }
      }
      , {
        title: {
          principale: 'La Tête Rousse'
          , secondaire: "Pour vous faire tourner la tête"
        }
        , info: {
          textI: " Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi sint asperiores, soluta ipsam. Enim ducimus ab voluptatibus a est perferendis, tempora, aliquam dolore reiciendis voluptates excepturi, aperiam veritatis vero sed.",
      ...
      , {
        title: {
          principale: 'Le trêfle à 4 feuilles'
          , secondaire: "Pour vous faire tourner la tête"
        }
        , info: {
          textI: " Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi sint asperiores, soluta ipsam. Enim ducimus ab voluptatibus a est perferendis, tempora, aliquam dolore reiciendis voluptates excepturi, aperiam veritatis vero sed."
